...
# Google Sheets Service with enhanced error handling
class GoogleSheetsService:
    ...
    @handle_errors
    def create_worksheet_if_not_exists(self, sheet_name: str, rows: int = 100, cols: int = 20, headers: List[str] = None):
...
def load_leads() -> pd.DataFrame:
    ...
    gs_service.create_worksheet_if_not_exists(
        SheetNames.LEADS, 
        100, 
